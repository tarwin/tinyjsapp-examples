...
**⬇ Download:** [sqlittle-0.1.2.dmg](https://github.com/tarwin/tinyjsapp-examples/raw/main/_builds/sqlittle-0.1.2.dmg) **(5.0 MB)** — prebuilt, signed & notarized; open and drag to Applications.
