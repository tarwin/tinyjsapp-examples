...
**⬇ Download:** macOS [Apple Silicon](https://github.com/tarwin/tinyjsapp-examples/releases/download/kraa3d-v0.2.7/kraa3d-0.2.7.dmg) / [Intel](https://github.com/tarwin/tinyjsapp-examples/releases/download/kraa3d-v0.2.7/kraa3d-0.2.7-macos-x86_64.dmg) **(4.9 MB)** — prebuilt, signed & notarized; open and drag to Applications.
