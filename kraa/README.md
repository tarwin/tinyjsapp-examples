...
**⬇ Download:** macOS [Apple Silicon](https://github.com/tarwin/tinyjsapp-examples/releases/download/kraa-v0.1.8/kraa-0.1.8.dmg) / [Intel](https://github.com/tarwin/tinyjsapp-examples/releases/download/kraa-v0.1.8/kraa-0.1.8-macos-x86_64.dmg) **(4.3 MB)** — prebuilt, signed & notarized; open and drag to Applications.
