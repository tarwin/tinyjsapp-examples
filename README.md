...
**⬇ Download:** macOS [nib-0.1.6.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/nib-v0.1.6/nib-0.1.6.dmg) **(4.2 MB, signed & notarized)** · Windows [nib-0.1.6-win.zip](https://github.com/tarwin/tinyjsapp-examples/releases/download/nib-v0.1.6/nib-0.1.6-win.zip) **(3.6 MB)** · Linux [nib-0.1.8-linux (x86_64)](https://github.com/tarwin/tinyjsapp-examples/releases/download/nib-v0.1.8/nib-0.1.8-linux-x86_64.tar.gz) / [(arm64)](https://github.com/tarwin/tinyjsapp-examples/releases/download/nib-v0.1.8/nib-0.1.8-linux-arm64.tar.gz) **(6.0 MB)**
