...
**⬇ Download:** macOS [nib-0.1.8.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/nib-v0.1.8/nib-0.1.8.dmg) **(5.5 MB, signed & notarized)** · Windows [nib-0.1.9-win.zip](https://github.com/tarwin/tinyjsapp-examples/releases/download/nib-v0.1.9/nib-0.1.9-win.zip) **(7.8 MB)** · Linux [nib-0.1.10-linux (x86_64)](https://github.com/tarwin/tinyjsapp-examples/releases/download/nib-v0.1.10/nib-0.1.10-linux-x86_64.tar.gz) / [(arm64)](https://github.com/tarwin/tinyjsapp-examples/releases/download/nib-v0.1.10/nib-0.1.10-linux-arm64.tar.gz) **(6.0 MB)**
