...
**⬇ Download:** [coo3d-0.2.1.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/coo3d-v0.2.3/coo3d-0.2.1.dmg) **(5.4 MB)** — prebuilt, signed & notarized; open and drag to Applications.
