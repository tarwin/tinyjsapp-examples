...
**⬇ Download:** [lumber-0.1.2.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/lumber-v0.1.4/lumber-0.1.2.dmg) **(4.7 MB)** — prebuilt, signed & notarized; open and drag to Applications.
