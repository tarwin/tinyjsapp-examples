...
**⬇ Download:** [amp-0.9.1.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/amp-v0.9.1/amp-0.9.1.dmg) **(6.5 MB)** — prebuilt, signed & notarized; open and drag to Applications.
