...
**⬇ Download:** [amp-0.9.0.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/amp-v0.9.0/amp-0.9.0.dmg) **(6.4 MB)** — prebuilt, signed & notarized; open and drag to Applications.
