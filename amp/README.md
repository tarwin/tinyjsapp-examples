...
**⬇ Download:** [amp-0.7.0.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/amp-v0.8.0/amp-0.7.0.dmg) **(5.2 MB)** — prebuilt, signed & notarized; open and drag to Applications.
