// q5.js 4.8.0 — LGPL-3.0-only, from https://q5js.org/
//
// A small p5-compatible sketch library. Ships whole — it is already a classic script and only ~230 KB.
//
// Vendored for amp, NOT hand-edited: rebuilt by tools/build-vizlibs.mjs
// from q5@4.8.0, which is the source this corresponds to. amp pastes
// it in front of any plugin whose source says
//     // amp:uses q5
// and the library is then `Q5` inside that plugin's worker.
//
