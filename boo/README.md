...
**⬇ Download:** macOS [Apple Silicon](https://github.com/tarwin/tinyjsapp-examples/releases/download/boo-v0.1.7/boo-0.1.7.dmg) / [Intel](https://github.com/tarwin/tinyjsapp-examples/releases/download/boo-v0.1.7/boo-0.1.7-macos-x86_64.dmg) **(4.1 MB)** — prebuilt, signed & notarized; open and drag to Applications.
