...
**⬇ Download:** [treez-0.1.2.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/treez-v0.1.4/treez-0.1.2.dmg) **(4.2 MB)** — prebuilt, signed & notarized; open and drag to Applications.
