...
**⬇ Download:** [treez-0.1.7.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/treez-v0.1.7/treez-0.1.7.dmg) **(4.0 MB)** — prebuilt, signed & notarized; open and drag to Applications.
