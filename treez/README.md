...
**⬇ Download:** [treez-0.1.5.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/treez-v0.1.5/treez-0.1.5.dmg) **(4.0 MB)** — prebuilt, signed & notarized; open and drag to Applications.
