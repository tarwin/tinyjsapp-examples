...
**⬇ Download:** macOS [Apple Silicon](https://github.com/tarwin/tinyjsapp-examples/releases/download/treez-v0.1.7/treez-0.1.7.dmg) / [Intel](https://github.com/tarwin/tinyjsapp-examples/releases/download/treez-v0.1.7/treez-0.1.7-macos-x86_64.dmg) **(4.0 MB)** — prebuilt, signed & notarized; open and drag to Applications.
