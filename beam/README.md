...
**⬇ Download:** [beam-0.1.6.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/beam-v0.1.6/beam-0.1.6.dmg) **(4.2 MB)** — prebuilt, signed & notarized; open and drag to Applications.
