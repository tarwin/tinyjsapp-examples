...
**⬇ Download:** [beam-0.1.3.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/beam-v0.1.5/beam-0.1.3.dmg) **(4.5 MB)** — prebuilt, signed & notarized; open and drag to Applications.
