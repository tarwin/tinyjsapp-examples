...
**⬇ Download:** macOS [Apple Silicon](https://github.com/tarwin/tinyjsapp-examples/releases/download/platter-v0.4.0/platter-0.4.0.dmg) / [Intel](https://github.com/tarwin/tinyjsapp-examples/releases/download/platter-v0.4.0/platter-0.4.0-macos-x86_64.dmg) **(6.0 MB)** — prebuilt, signed & notarized; open and drag to Applications.
