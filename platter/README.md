...
**⬇ Download:** [platter-0.4.0.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/platter-v0.4.0/platter-0.4.0.dmg) **(6.0 MB)** — prebuilt, signed & notarized; open and drag to Applications.
