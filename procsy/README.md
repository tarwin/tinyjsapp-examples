...
**⬇ Download:** [procsy-0.1.3.dmg](https://github.com/tarwin/tinyjsapp-examples/releases/download/procsy-v0.1.5/procsy-0.1.3.dmg) **(4.8 MB)** — prebuilt, signed & notarized; open and drag to Applications.
