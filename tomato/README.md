...
**⬇ Download:** [tomato-0.1.2.dmg](https://github.com/tarwin/tinyjsapp-examples/raw/main/_builds/tomato-0.1.2.dmg) **(4.5 MB)** — prebuilt, signed & notarized; open and drag to Applications.
